...
# 2) axis=0 지정한 추가 ==> 행 추가 , 반드시 shape가 일치해야 된다.
...
[[  1   2   3]
 ...
 [100 200 300]]
'''
# 3) axis=1 지정한 추가 ==> 열 추가 ,반드시 shape가 일치해야 된다.
'''
[[1 2 3]
 [4 5 6]]
'''
...
# 2) axis=0 지정한 삽입 ==> 행 삽입,  반드시 shape가 일치해야 된다.
...
[[100 200 300]
 ...
 [  4   5   6]]
'''
# 3) axis=1 지정한 삽입 ==> 열 삽입,  반드시 shape가 일치해야 된다.
