...
new_df = pd.merge(df1, df2, how="left", on="x1") # left outer join
new_df = pd.merge(df1, df2, how="right", on="x1") # right outer join
new_df = pd.merge(df1, df2, how="outer", on="x1") # full outer join
print(new_df)
